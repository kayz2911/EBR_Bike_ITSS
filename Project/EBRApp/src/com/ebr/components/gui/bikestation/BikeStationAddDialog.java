...
public class BikeStationAddDialog extends ADataAddDialog<BikeStation> {
	...
	public BikeStationAddDialog(BikeStation bikeStation, IDataManageController<BikeStation> controller) {
	...
	public void buildControls() {
		...
		// district options
		districtOptions = GUIUtils.generateDistrictOptions("01");

		// ward options
		wardOptions = GUIUtils.generateWardOptions("001");
...
//		nameField.setText(t.getName());
		...
		provinceComboBox.setSelectedItem(new ProvinceOption("01"));
		...
		districtComboBox.setSelectedItem(new DistrictOption("001"));
		...
		wardComboBox.setSelectedItem(new WardOption("00001"));
		c.gridx = 1;
		c.gridy = row;
